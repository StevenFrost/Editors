...
namespace TextureMaxLoadEditor.Locations
{
    class FSX : IDisposable
    {
        ...
        public string GetExe()
        {
            ...
            else
            {
                ...
                MessageBox.Show("Unable to find a core FSX registry value. Please make sure that you have ran FSX at least once before running the Texture Max Load Editor.",
        ...
        public string GetCfg()
        {
            ...
            {
                // FSX registry value not found or is empty, show an error
                MessageBox.Show("Unable to find the fsx.CFG directory. Please make sure that you have ran FSX at least once before running the Texture Max Load Editor.",
